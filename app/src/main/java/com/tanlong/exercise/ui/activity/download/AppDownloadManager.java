...
public class AppDownloadManager {
    ...
    private IAndroidOInstallPermissionListener iAndroidOInstallPermissionListener;
    /**
     * 下载任务ID
     */
    private long mReqId;
        ...
        public void onReceive(final Context context, final Intent intent) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                if (!haveInstallPermission) {
                    //请求权限
                    iAndroidOInstallPermissionListener = new IAndroidOInstallPermissionListener() {
                        @Override
    ...
    private void installApk(Context context, Intent intent) {
        ...
        if (completeDownLoadId == mReqId) {
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
                ...
                //7.0及以上
                uri = FileProvider.getUriForFile(context, FILE_PROVIDER_AUTH, getApkFile());
