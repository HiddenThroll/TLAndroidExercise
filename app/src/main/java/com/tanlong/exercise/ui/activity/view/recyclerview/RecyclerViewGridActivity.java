    ...
    private void initView() {
        ...
        adapter.setmOnItemClickListener(new SimpleRecyclerViewAdapter.OnItemClickListener() {
            ...
            public void onClick(View view, int position) {
                ToastHelp.showShortMsg(RecyclerViewGridActivity.this, "onClick " + mDatas.get(position));
            }

            @Override
            public void onLongClick(View view, int position) {
                ToastHelp.showShortMsg(RecyclerViewGridActivity.this, "onLongClick " + mDatas.get(position));
            }
        });
    }
